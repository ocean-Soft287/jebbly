...
abstract interface class Gaps {
  ...
  static SizedBox v4() => const SizedBox(height: 4);
  ...
  static SizedBox h4() => const SizedBox(width: 4);
  ...
  static SizedBox h50() => const SizedBox(width: 50);
  static SizedBox v50() => const SizedBox(height: 50);
